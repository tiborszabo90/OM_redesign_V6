...
import { Info, ShoppingCart, Star, Search } from 'lucide-vue-next'
...
const props = defineProps({
  ...
  styleObj: { type: Object, required: true },         // chosen style { preview, img, overlay }
...
// The creative picked on the style step is what every AI slot shows here.
const creative = computed(() => props.styleObj.preview || props.styleObj.img)
  ...
  <div class="grid grid-cols-[1fr_1.15fr] gap-4">
    ...
    <div class="pb-card overflow-hidden self-start">
      ...
      <div class="flex items-center gap-1.5 px-3 py-2 bg-[#f2f2f2] border-b border-[#e6e6e6]">
        ...
        <div class="ml-2 flex-1 bg-white border border-[#e0e0e0] rounded-full px-2.5 py-0.5 text-[9px] text-[#8a8a8a] truncate">roast-and-co.com/products/lumina-glow-cream</div>
      </div>
      ...
      <div class="p-3.5">
        <div class="grid grid-cols-2 gap-3">
          ...
          <div>
            <div
              class="rounded-lg overflow-hidden aspect-square mb-1.5 cursor-pointer"
              :class="isGallery ? 'ring-2 ring-[#b2592e]' : 'border border-[#f0f0f0]'"
              @click="select('replace')"
            >
              <img :src="heroType === 'ai' ? creative : product.img" class="w-full h-full object-cover" />
            </div>
            <div class="flex gap-1.5">
              ...
              >
                <img v-if="slot === 'ai'" :src="creative" class="w-full h-full object-cover" />
          ...
          <!-- product info -->
          <div>
            <p class="text-[9px] text-[#8a8a8a] mb-1">Home / Skincare</p>
            ...
            <p class="text-[10px] text-[#616161] mt-1.5 leading-relaxed">Lightweight daily moisturizer with niacinamide, for a brighter, calmer glow.</p>
            <div class="flex gap-1.5 mt-2">
              <span class="text-[10px] font-semibold border border-[#1a1a1a] rounded-md px-2 py-0.5">50 ml</span>
              <span class="text-[10px] font-medium border border-[#dcdcdc] text-[#8a8a8a] rounded-md px-2 py-0.5">100 ml</span>
            </div>
        ...
        <div
          ...
          class="rounded-lg overflow-hidden mt-3 ring-2 ring-[#b2592e] pb-fade-in cursor-pointer"
          @click="select('below-hero')"
        >
          <img :src="creative" class="w-full block" />
        </div>
        ...
        <div
          ...
          class="rounded-lg overflow-hidden mt-2 ring-2 ring-[#b2592e] pb-fade-in cursor-pointer"
        ...
        <template v-if="modelValue === 'custom'">
          <div class="rounded-lg overflow-hidden mt-2 ring-2 ring-[#b2592e] pb-fade-in">
            <img :src="creative" class="w-full block" />
          </div>
