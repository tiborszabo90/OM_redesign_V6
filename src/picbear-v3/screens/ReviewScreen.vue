    ...
    <div class="flex flex-col gap-3">
      <div v-for="p in selectedProducts" :key="p.id" class="pb-card px-4 py-3 flex items-center gap-4">
        <div class="flex items-center gap-2.5 shrink-0">
          ...
          <div class="w-24 h-24 rounded-lg overflow-hidden relative ring-1 ring-[#f2d9c9]">
        ...
        <button class="pb-btn-ghost shrink-0" @click="openEditor(p.id, 'review')" title="Fine-tune">
