    ...
    <div class="grid grid-cols-1 md:grid-cols-[200px_minmax(0,1fr)] gap-4 items-start">
      ...
      <div v-else-if="state.editSection === 'products'" class="pb-card p-5">
        ...
        <div class="flex items-center gap-3 mb-4 flex-wrap">
          ...
          <select
            v-model="category"
            class="rounded-lg border border-[#d4d4d4] px-2.5 py-2 text-[13px] bg-white outline-none"
          >
      ...
      <div v-else>
        ...
        <div class="pb-card p-4 mb-4">
          ...
          <label class="flex items-center gap-2 text-[13px] text-[#303030] mb-3 cursor-pointer select-none">
            <input type="checkbox" v-model="batch.ratioSame" class="w-4 h-4 accent-[#1a1a1a]" />
          ...
          <div class="flex gap-3 max-w-[420px]">
            <div class="flex-1">
              ...
              <select v-model="batch.desktopRatio" class="w-full rounded-lg border border-[#d4d4d4] px-2.5 py-1.5 text-[13px] bg-white outline-none">
            ...
            <div class="flex-1" :class="batch.ratioSame ? 'opacity-45 pointer-events-none' : ''">
              ...
              <select v-model="batch.mobileRatio" :disabled="batch.ratioSame" class="w-full rounded-lg border border-[#d4d4d4] px-2.5 py-1.5 text-[13px] bg-white outline-none">
                <option v-for="r in ratioOptions" :key="r" :value="r">{{ r }}</option>
              </select>
            </div>
          </div>
