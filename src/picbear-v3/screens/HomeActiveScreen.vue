      ...
      <div class="flex flex-col gap-2">
        ...
        >
          ...
          <div class="flex-1 min-w-0">
            ...
            <p class="text-[12px] text-[#616161]">{{ styleById(b.styleId).name }} · {{ b.generatedIds.length }} products</p>
          </div>
    ...
    <div class="grid grid-cols-2 gap-4">
      ...
      <div class="pb-card p-5 flex flex-col">
        ...
        <div class="h-1.5 bg-[#ececec] rounded-full overflow-hidden mb-2">
          <div class="h-full bg-[#b2592e] rounded-full" :style="{ width: Math.min(liveProducts.length / Math.min(quota, 36) * 100, 100) + '%' }"></div>
        </div>
