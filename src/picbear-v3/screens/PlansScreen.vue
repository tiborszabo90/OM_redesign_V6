    ...
    <template v-else>
      <div class="grid grid-cols-3 gap-4 mb-5">
        <div
          ...
          :class="isCurrent(plan) ? 'ring-2 ring-[#36c98e]' : (plan.recommended ? 'ring-1 ring-[#f2d9c9]' : '')"
        >
          <span
            v-if="isCurrent(plan)"
          ...
          <span
            ...
            class="absolute -top-2.5 left-4 text-[10px] font-semibold text-white bg-[#b2592e] rounded-full px-2 py-0.5"
          >
            Recommended
          </span>
