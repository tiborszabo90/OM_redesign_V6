<template>
  <div class="xl:pr-16">
    <div class="mb-8">
      <h2 class="text-xl font-semibold text-[#23262A]">Honnan hallottál rólunk?</h2>
    </div>
...
const mainOptions = [
  { value: 'partner-agency', label: 'Partner/ügynökség' },
  { value: 'shopify-wordpress', label: 'Shopify/WordPress' },
  { value: 'google-search', label: 'Google keresés' },
  { value: 'instagram-facebook', label: 'Instagram/Facebook' },
  { value: 'friend-colleague', label: 'Barát/kolléga' },
  { value: 'chatgpt', label: 'ChatGPT' },
  { value: 'youtube', label: 'YouTube' },
  { value: 'linkedin', label: 'LinkedIn' },
  { value: 'already-used', label: 'Korábban már használtam' },
  { value: 'sales-inquiry', label: 'Értékesítési megkeresés' }
]
