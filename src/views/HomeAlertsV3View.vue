      ...
      <div class="w-full max-w-[1400px] mx-auto -mt-3">
        ...
        <div class="flex items-center justify-between mb-5 gap-4 max-960:flex-col max-960:items-start">
          ...
          <div class="flex items-center gap-4">
            ...
            <!-- Alert count chip -->
            <div v-if="alerts.length" class="relative">
              <button
                type="button"
              ...
              >
                ...
                <span class="text-sm font-semibold text-om-gray-700 whitespace-nowrap">
...
const alerts = ref([
  ...
  {
    id: 'woocommerce-new-plugin-no-api-key',
    title: 'Add your WooCommerce REST API key',
    body: [
      { text: 'The new WooCommerce plugin needs a REST API key to sync product data. ' },
      { text: 'Generate a key', href: '#' },
      { text: ' in your WooCommerce settings and paste it on the Integrations page.' },
    ],
  },
])
