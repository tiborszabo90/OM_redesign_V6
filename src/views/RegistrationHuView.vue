        ...
        <div class="w-full max-w-[516px]">
          ...
          <div :key="currentStep" class="w-full">
            ...
            <template v-if="currentStep === 'buttons'">
              <h2 class="text-4xl font-bold text-om-gray-700 mb-1 text-center">Teszteld 14 napig kockázatmentesen</h2>
              <p class="text-sm text-om-gray-500 mb-8 text-center">Nem kérünk kártyaadatot. Nincs apró betűs rész.<br>Csak eredmények.</p>
            ...
            <template v-else-if="currentStep === 'email-form'">
              <h2 class="text-4xl font-bold text-om-gray-700 mb-1 text-center">Teszteld 14 napig kockázatmentesen</h2>
              <p class="text-sm text-om-gray-500 mb-6 text-center">Nem kérünk kártyaadatot. Nincs apró betűs rész.<br>Csak eredmények.</p>
              ...
              <form @submit.prevent="handleEmailSubmit" class="space-y-3">
                ...
                <div>
                  ...
                  <input
                    ...
                    class="w-full px-3 py-2.5 border border-om-gray-200 rounded-xl focus:ring-2 focus:ring-om-orange-400 focus:border-transparent transition-colors text-om-gray-700 text-sm"
                  />
                  <p class="text-xs text-om-gray-400 mt-1.5">Fontos értesítéseket és tájékoztatókat fogsz kapni a fiókoddal kapcsolatban.</p>
                </div>
