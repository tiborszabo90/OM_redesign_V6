              ...
              <transition name="panel">
                ...
                >
                  ...
                  <div class="px-6 py-10 text-center">
                    <div class="w-12 h-12 mx-auto rounded-full bg-emerald-50 flex items-center justify-center mb-3">
                      <Activity :size="22" class="text-emerald-500" />
                    </div>
                    <h3 class="text-base font-semibold text-om-gray-700 mb-1">No live visitors right now</h3>
                    <p class="text-sm text-om-gray-500 leading-relaxed max-w-sm mx-auto">
                      Tracking on <span class="font-medium text-om-gray-700">{{ selectedDomain }}</span> is working. New visitors will show up here as soon as they land on your site.
                    </p>
                  </div>

                  <div class="px-5 py-2.5 border-t border-gray-100 bg-gray-50/50">
                    <div class="flex items-center justify-end text-xs text-om-gray-400">
                      <span class="flex items-center gap-1">
                        <RotateCw :size="10" class="animate-spin-slow" />
                        Auto-refreshing
                      </span>
                    </div>
                  </div>
...
// ── Heartbeat (0 live visitors, healthy — code working, last signal within 24h) ──
