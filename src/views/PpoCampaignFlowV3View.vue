  ...
  <div class="h-screen flex flex-col bg-om-gray-50">
    ...
    <div class="flex-1 overflow-y-auto">
      <div class="max-w-5xl mx-auto px-8 py-10">
        <h2 class="text-2xl font-semibold text-om-gray-700 mb-2 text-center">What would you like to change on your product pages?</h2>
        <p class="text-sm text-om-gray-500 mb-8 text-center">You can select multiple elements — we'll optimize them all at once.</p>
            ...
            <div class="w-full bg-om-gray-100 flex items-center justify-center relative overflow-hidden" :class="type.id === 'image-badge' || type.id === 'product-summary' ? 'aspect-4/3' : 'aspect-16/10'">
              ...
              <div v-else-if="type.id === 'image-badge' || type.id === 'product-summary'" class="w-full h-full bg-white overflow-hidden flex flex-col px-3 py-2 gap-2">
                ...
                <div class="flex gap-2 shrink-0">
                  <div class="w-10 h-10 bg-om-gray-100 rounded shrink-0" />
        ...
        <p class="text-xs text-om-gray-400 mt-6 text-center">{{ selectedTypes.length }} element{{ selectedTypes.length !== 1 ? 's' : '' }} selected</p>
      </div>
    </div>
  </div>
</template>
