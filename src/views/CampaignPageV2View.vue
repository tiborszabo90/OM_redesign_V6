  ...
  <DashboardLayout active-menu-item="campaigns" @logo-click="handleLogoClick" @menu-click="$emit('menu-click', $event)" :right-panel-collapsed="!isChatOpen">
    <template #content>
      <div class="w-full max-w-[1400px] mx-auto -mt-2">
        ...
        <!-- Top Optimization Opportunities — text only -->
        <div class="bg-white rounded-lg shadow-[0_1px_2px_1px_rgb(0_0_0/0.03)] mb-6 p-6 flex items-center gap-6">
          <img src="/monk_bulb.svg" alt="Monk with lightbulb" class="w-32 h-32 object-contain shrink-0" />
          <div class="flex-1 min-w-0">
            <h2 class="text-lg font-semibold text-om-gray-700 mb-1">We found new optimization insights for this campaign</h2>
            <p class="text-sm text-om-gray-500 leading-relaxed">
              Based on this campaign's performance and visitor behavior, we've spotted concrete opportunities to lift its conversion rate. Check them out and decide where to focus first.
            </p>
          </div>
          <Button variant="secondary" size="md" class="shrink-0 ml-20" @click="emit('navigate-to-opportunities')">
