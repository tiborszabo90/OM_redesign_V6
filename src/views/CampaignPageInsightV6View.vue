  ...
  <DashboardLayout active-menu-item="campaigns" @logo-click="handleLogoClick" @menu-click="$emit('menu-click', $event)" :right-panel-collapsed="!isChatOpen">
    <template #content>
      <div class="w-full max-w-[1400px] mx-auto -mt-2">
        ...
        <div class="bg-white rounded-lg shadow-[0_1px_2px_1px_rgb(0_0_0/0.03)] py-10 px-12 mb-6 grid grid-cols-2 items-center gap-24">
          ...
          <img src="/insights_v2.svg" alt="Insights" class="w-120 h-auto object-contain justify-self-end" />
        </div>
