...
import { TrendingUp, TrendingDown, Target, Calendar, UserPlus, Signpost, X, LayoutTemplate, Zap, Plug, Check, ChevronDown, AlertCircle } from 'lucide-vue-next'
...
const homeCampaigns = reactive([
  {
    ...
    metrics: [
      ...
      { label: 'Conversion uplift', value: '0%' },
    ],
  },
])
