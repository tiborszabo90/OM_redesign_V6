    ...
    <template #content>
      ...
      <div class="flex flex-col items-center justify-center h-full py-16 -translate-y-[5%]">
        ...
        <div class="flex flex-wrap justify-center gap-6">
          <!-- Featured: Agentic OptiMonk (mirrors the top-right promo on Home agentic link) -->
          <button
            class="relative flex flex-col items-center gap-5 bg-white border-2 border-om-gray-200 rounded-xl p-8 w-72 cursor-pointer hover:border-om-orange-500 hover:shadow-[0_4px_14px_rgba(237,90,41,0.4)] hover:scale-[1.03] transition-all duration-200 text-left"
            @click="showAgenticModal = true"
          >
            <img src="/agentic.svg" alt="Agentic OptiMonk" class="w-36 h-36 object-contain shrink-0" />
            <div class="text-center">
              <div class="text-lg font-semibold text-om-gray-700 mb-1">Agentic OptiMonk</div>
              <div class="text-base text-om-gray-400 leading-relaxed">Turn any image into a popup, or let AI design from your brand.</div>
            </div>
          </button>
