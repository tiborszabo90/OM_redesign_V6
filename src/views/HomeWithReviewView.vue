<template>
  <DashboardLayout @logo-click="handleLogoClick" @menu-click="$emit('menu-click', $event)" :right-panel-collapsed="!isChatOpen" background-color="white">
    <template #content>
      ...
      <div v-if="showReviewScreen" class="flex items-center justify-center h-full">
        <div class="text-center max-w-sm px-8">
          <img src="/review_img.png" alt="" class="mx-auto mb-0 h-72" />
