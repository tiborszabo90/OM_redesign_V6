  ...
  <DashboardLayout @logo-click="handleLogoClick" @menu-click="$emit('menu-click', $event)" :right-panel-collapsed="!isChatOpen || chatWideMode" :content-hidden="chatWideMode">
    <template #content>
      <div class="w-full max-w-[1400px] mx-auto -mt-3">
        ...
        <div class="bg-om-gray-100 rounded-lg py-10 px-12 grid grid-cols-2 items-center gap-24 mb-10">
          <div class="min-w-0 flex flex-col gap-3">
            <div>
              <h2 class="text-lg font-semibold text-om-gray-700">Your insights report is ready</h2>
              <span class="inline-flex items-center gap-1.5 text-xs font-medium text-om-gray-700 bg-om-gray-200 px-2.5 py-1 rounded-full whitespace-nowrap mt-3">
                <Calendar :size="12" />
