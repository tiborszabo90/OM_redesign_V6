    ...
    <template #content>
      <div class="w-full max-w-[1400px] mx-auto -mt-2">
        ...
        <div class="bg-white rounded-lg shadow-[0_1px_2px_1px_rgb(0_0_0/0.03)] mb-5 pt-5 pb-5 pl-5 pr-8">
          ...
          <!-- Add Variant -->
          <div class="mt-2">
            <button class="w-full flex items-center gap-4 p-3 border-2 border-dashed border-om-gray-200 rounded-lg text-left hover:border-om-gray-300 cursor-pointer transition-colors">
              <div class="w-10 h-10 bg-om-orange-100 rounded-xl flex items-center justify-center shrink-0">
                <Plus :size="20" class="text-om-orange-500" />
              </div>
              <div class="flex-1 min-w-0">
                <div class="text-sm font-semibold text-om-gray-700">Add variant</div>
                <div class="text-xs text-om-gray-500 mt-0.5">Run side-by-side as an A/B test, or create a new design version</div>
              </div>
            </button>
          </div>
        </div>
        ...
        <div class="space-y-5">
          ...
          <div class="bg-white rounded-lg shadow-[0_1px_2px_1px_rgb(0_0_0/0.03)] p-5 cursor-pointer hover:shadow-[0_2px_8px_2px_rgb(0_0_0/0.07)] transition-shadow" @click="openSettingsAccordion('whoSee')">
            <h3 class="text-base font-semibold text-om-gray-700 mb-4">Who should see this campaign?</h3>
                ...
                <div class="trigger-card">
                  <div class="flex items-center gap-3">
                    ...
                    <div class="flex-1">
                      ...
                      <div class="text-sm text-om-gray-500 mt-0.5">The campaign runs on <span class="font-semibold text-om-gray-800">73 product pages</span> where all variables are generated.</div>
                    </div>
                  </div>
                </div>
              </div>
