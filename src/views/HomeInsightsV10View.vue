          ...
          <div class="flex-1 min-w-0 flex flex-col gap-3">
            ...
            <div class="flex flex-col gap-2 mt-1">
              <button
                ...
                class="flex items-center gap-3 text-left group cursor-pointer bg-white rounded-lg shadow-[0_1px_3px_rgba(0,0,0,0.08),0_1px_2px_rgba(0,0,0,0.04)] hover:shadow-[0_4px_10px_rgba(0,0,0,0.08),0_2px_4px_rgba(0,0,0,0.06)] transition-shadow px-3 py-2 w-fit max-w-[80%]"
              >
