            ...
            <div class="flex items-center">
              ...
              >
                ...
                <input
                  ...
                  class="pl-9 pr-8 py-2 text-sm border border-om-gray-200 rounded-lg bg-white text-om-gray-700 placeholder-om-gray-400 focus:outline-none focus:border-om-gray-300 w-full"
                />
                <button
                  v-if="searchOpen"
                  class="absolute right-2 top-1/2 -translate-y-1/2 text-om-gray-400 hover:text-om-gray-600 cursor-pointer"
                  @click="closeSearch"
                >
                  <X :size="14" />
                </button>
              </div>
              <Button v-if="!searchOpen" variant="ghost" size="sm" icon-only @click="openSearch">
...
import { Plus, Search, X, Calendar, ArrowUpDown, Check, ChevronLeft, ChevronRight, Trash2, Archive } from 'lucide-vue-next'
