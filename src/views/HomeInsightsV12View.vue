      ...
      <div class="w-full max-w-[1400px] mx-auto -mt-3">
        ...
        <div class="flex items-center justify-between mb-5 gap-4 max-960:flex-col max-960:items-start">
          ...
          <div class="flex items-center gap-4">
            ...
            <div class="relative">
              <!-- Heartbeat indicator — no signal in 24h -->
              <button
                type="button"
                ...
                >
                  ...
                  <div class="px-6 py-10 text-center">
                    ...
                    <p class="text-sm text-om-gray-500 leading-relaxed max-w-sm mx-auto mb-5">
                      We haven't received a signal from <span class="font-medium text-om-gray-700">{{ selectedDomain }}</span> in the past 24 hours. The OptiMonk code may have been removed, blocked, or stopped firing, or your site simply had no traffic.
                    </p>
