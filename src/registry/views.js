...
const systemViews = [
  ...
  {
    id: 'picbear-dev-start',
    component: () => import('../picbear/PicbearDevStartView.vue'),
    label: 'Picbear (choose version)',
    status: 'system',
    section: null,
    hideLogo: true,
    product: 'picbear',
  ...
  },
  {
    ...
    hideLogo: true,
    product: 'picbear',
    matchPrefix: 'picbear-v2',
  },
  {
    id: 'picbear-v3',
    component: () => import('../picbear-v3/PicbearAppView.vue'),
    label: 'Picbear V3',
    status: 'system',
    section: null,
    hideLogo: true,
    product: 'picbear',
    matchPrefix: 'picbear-v3',
  },
  {
    id: 'conversionlift',
...
const homeViews = [
  ...
  {
    id: 'home-agentic-link',
    component: () => import('../views/HomeAgenticLinkView.vue'),
    label: 'Home (agentic link)',
    status: 'active',
    section: 'home',
    hideLogo: true,
    keyPrefix: 'home-agentic-link',
    nav: { sessionReset: true, flowSelected: true, clearWizardMessage: true },
  },
  {
    id: 'home-agentic-link-promo',
    component: () => import('../views/HomeAgenticLinkView.vue'),
    label: 'Home (agentic link + variations promo)',
    status: 'active',
    section: 'home',
    hideLogo: true,
    keyPrefix: 'home-agentic-link-promo',
    nav: { sessionReset: true, flowSelected: true, clearWizardMessage: true },
  },
  {
...
const campaignViews = [
  ...
  {
    id: 'new-campaign-agentic',
    component: () => import('../views/NewCampaignAgenticView.vue'),
    label: 'New Campaign (agentic)',
    status: 'active',
    section: null,
    hideLogo: true,
  },
  ...
  {
    id: 'campaign-page-agentic',
    component: () => import('../views/CampaignPageAgenticView.vue'),
    label: 'Campaign Page (agentic concepts)',
    status: 'active',
    section: 'campaignPage',
    hideLogo: true,
