...
const activeProps = computed(() => {
  ...
  const propsConfig = {
    ...
    'optiqube-session-original': { product: 'optiqube', startPath: '/session' },
    'optiqube-session-v2': { product: 'optiqube', startPath: '/session-v2' },
    'optiqube-session-v3': { product: 'optiqube', startPath: '/session-v3' },
    'optiqube-session-v3-no-catalog': { product: 'optiqube', startPath: '/session-v3-no-catalog' },
    'optiqube-session-v4': { product: 'optiqube', startPath: '/session-v4' },
    'optiqube-session-v5': { product: 'optiqube', startPath: '/session-v5' },
    ...
    'home-agentic-link': { registrationData: registrationData.value, showVariationsPromo: true },
    'home-agentic-link-promo': { registrationData: registrationData.value, showVariationsPromo: true },
    ...
    'home-insights-v3': { registrationData: registrationData.value },
    'home-insights-v4': { registrationData: registrationData.value },
    'home-insights-v5': { registrationData: registrationData.value },
    'home-insights-v6': { registrationData: registrationData.value },
    'home-insights-v7': { registrationData: registrationData.value },
    'home-insights-v8': { registrationData: registrationData.value },
    'home-insights-v9': { registrationData: registrationData.value },
    'home-insights-v10': { registrationData: registrationData.value },
    'home-heartbeat-setup': { registrationData: registrationData.value },
    'home-no-domain': { registrationData: registrationData.value },
    'home-heartbeat-offline': { registrationData: registrationData.value },
    'home-heartbeat-quiet': { registrationData: registrationData.value },
    ...
    'campaign-page-agentic': { abTestVersion: 'comparison' },
    'campaign-page-agentic-2': { abTestVersion: 'comparison' },
    'campaign-detail-segment-size': { abTestVersion: 'comparison' },
    'campaign-detail-tagged': { abTestVersion: 'comparison' },
    'campaign-page-survey': { abTestVersion: 'comparison' },
    'campaign-page-alerts-banner': { abTestVersion: 'comparison' },
    'campaign-page-alerts-chip': { abTestVersion: 'comparison' },
    'campaign-page-insight-v1': { abTestVersion: 'comparison' },
    'campaign-page-insight-v2': { abTestVersion: 'comparison' },
    'campaign-page-insight-v3': { abTestVersion: 'comparison' },
    'campaign-page-insight-v4': { abTestVersion: 'comparison' },
    'campaign-page-insight-v5': { abTestVersion: 'comparison' },
    'campaign-page-insight-v6': { abTestVersion: 'comparison' },
    'campaign-page-insight-v7': { abTestVersion: 'comparison' },
    'campaign-page-insight-v8': { abTestVersion: 'comparison' },
    'campaign-page-v2': { abTestVersion: 'comparison' },
  ...
  if (id === 'settings-ai-texts-images-v2-next-product') {
    return {
      initialSection: settingsInitialSection.value,
      initialScreen: 'generation',
    }
...
const activeEvents = computed(() => {
  ...
  const eventsConfig = {
    ...
    'optiqube-session-original': { navigate: handleDevNavigate },
    'optiqube-session-v2': { navigate: handleDevNavigate },
    'optiqube-session-v3': { navigate: handleDevNavigate },
    'optiqube-session-v3-no-catalog': { navigate: handleDevNavigate },
    'optiqube-session-v4': { navigate: handleDevNavigate },
    'optiqube-session-v5': { navigate: handleDevNavigate },
    ...
    'home-agentic-link': { 'menu-click': handleMenuClick, 'navigate-to': handleDevNavigate, 'new-campaign': () => { currentView.value = 'new-campaign-agentic' }, 'go-chat-left': () => { currentView.value = 'home-chat-left' }, 'navigate-to-opportunity': handleNavigateToOpportunityV4, 'navigate-to-opportunities': handleNavigateToOpportunitiesV4, 'open-editor-with-chat': (messages) => { editorChatHistory.value = messages; currentView.value = 'editor' }, 'visitor-click': handleVisitorClick },
    'home-agentic-link-promo': { 'menu-click': handleMenuClick, 'navigate-to': handleDevNavigate, 'new-campaign': () => { currentView.value = 'new-campaign-agentic' }, 'go-chat-left': () => { currentView.value = 'home-chat-left' }, 'navigate-to-opportunity': handleNavigateToOpportunityV4, 'navigate-to-opportunities': handleNavigateToOpportunitiesV4, 'open-editor-with-chat': (messages) => { editorChatHistory.value = messages; currentView.value = 'editor' }, 'visitor-click': handleVisitorClick },
    ...
    'home-insights-v3': { 'menu-click': handleMenuClick, 'navigate-to': handleDevNavigate, 'new-campaign': () => { currentView.value = 'new-campaign' }, 'navigate-to-opportunity': handleNavigateToOpportunityV4, 'navigate-to-opportunities': handleNavigateToOpportunitiesV4, 'open-editor-with-chat': (messages) => { editorChatHistory.value = messages; currentView.value = 'editor' }, 'visitor-click': handleVisitorClick },
    'home-insights-v4': { 'menu-click': handleMenuClick, 'navigate-to': handleDevNavigate, 'new-campaign': () => { currentView.value = 'new-campaign' }, 'navigate-to-opportunity': handleNavigateToOpportunityV4, 'navigate-to-opportunities': handleNavigateToOpportunitiesV4, 'open-editor-with-chat': (messages) => { editorChatHistory.value = messages; currentView.value = 'editor' }, 'visitor-click': handleVisitorClick },
    'home-insights-v5': { 'menu-click': handleMenuClick, 'navigate-to': handleDevNavigate, 'new-campaign': () => { currentView.value = 'new-campaign' }, 'navigate-to-opportunity': handleNavigateToOpportunityV4, 'navigate-to-opportunities': handleNavigateToOpportunitiesV4, 'open-editor-with-chat': (messages) => { editorChatHistory.value = messages; currentView.value = 'editor' }, 'visitor-click': handleVisitorClick },
    'home-insights-v6': { 'menu-click': handleMenuClick, 'navigate-to': handleDevNavigate, 'new-campaign': () => { currentView.value = 'new-campaign' }, 'navigate-to-opportunity': handleNavigateToOpportunityV4, 'navigate-to-opportunities': handleNavigateToOpportunitiesV4, 'open-editor-with-chat': (messages) => { editorChatHistory.value = messages; currentView.value = 'editor' }, 'visitor-click': handleVisitorClick },
    'home-insights-v7': { 'menu-click': handleMenuClick, 'navigate-to': handleDevNavigate, 'new-campaign': () => { currentView.value = 'new-campaign' }, 'navigate-to-opportunity': handleNavigateToOpportunityV4, 'navigate-to-opportunities': handleNavigateToOpportunitiesV4, 'open-editor-with-chat': (messages) => { editorChatHistory.value = messages; currentView.value = 'editor' }, 'visitor-click': handleVisitorClick },
    'home-insights-v8': { 'menu-click': handleMenuClick, 'navigate-to': handleDevNavigate, 'new-campaign': () => { currentView.value = 'new-campaign' }, 'navigate-to-opportunity': handleNavigateToOpportunityV4, 'navigate-to-opportunities': handleNavigateToOpportunitiesV4, 'open-editor-with-chat': (messages) => { editorChatHistory.value = messages; currentView.value = 'editor' }, 'visitor-click': handleVisitorClick },
    'home-insights-v9': { 'menu-click': handleMenuClick, 'navigate-to': handleDevNavigate, 'new-campaign': () => { currentView.value = 'new-campaign' }, 'navigate-to-opportunity': handleNavigateToOpportunityV4, 'navigate-to-opportunities': handleNavigateToOpportunitiesV4, 'open-editor-with-chat': (messages) => { editorChatHistory.value = messages; currentView.value = 'editor' }, 'visitor-click': handleVisitorClick },
    'home-insights-v10': { 'menu-click': handleMenuClick, 'navigate-to': handleDevNavigate, 'new-campaign': () => { currentView.value = 'new-campaign' }, 'navigate-to-opportunity': handleNavigateToOpportunityV4, 'navigate-to-opportunities': handleNavigateToOpportunitiesV4, 'open-editor-with-chat': (messages) => { editorChatHistory.value = messages; currentView.value = 'editor' }, 'visitor-click': handleVisitorClick },
    'home-heartbeat-setup': { 'menu-click': handleMenuClick, 'navigate-to': handleDevNavigate, 'new-campaign': () => { currentView.value = 'new-campaign' }, 'navigate-to-opportunity': handleNavigateToOpportunityV4, 'navigate-to-opportunities': handleNavigateToOpportunitiesV4, 'open-editor-with-chat': (messages) => { editorChatHistory.value = messages; currentView.value = 'editor' }, 'visitor-click': handleVisitorClick },
    'home-no-domain': { 'menu-click': handleMenuClick, 'navigate-to': handleDevNavigate, 'new-campaign': () => { currentView.value = 'new-campaign' }, 'navigate-to-opportunity': handleNavigateToOpportunityV4, 'navigate-to-opportunities': handleNavigateToOpportunitiesV4, 'open-editor-with-chat': (messages) => { editorChatHistory.value = messages; currentView.value = 'editor' }, 'visitor-click': handleVisitorClick },
    'home-heartbeat-offline': { 'menu-click': handleMenuClick, 'navigate-to': handleDevNavigate, 'new-campaign': () => { currentView.value = 'new-campaign' }, 'navigate-to-opportunity': handleNavigateToOpportunityV4, 'navigate-to-opportunities': handleNavigateToOpportunitiesV4, 'open-editor-with-chat': (messages) => { editorChatHistory.value = messages; currentView.value = 'editor' }, 'visitor-click': handleVisitorClick },
    'home-heartbeat-quiet': { 'menu-click': handleMenuClick, 'navigate-to': handleDevNavigate, 'new-campaign': () => { currentView.value = 'new-campaign' }, 'navigate-to-opportunity': handleNavigateToOpportunityV4, 'navigate-to-opportunities': handleNavigateToOpportunitiesV4, 'open-editor-with-chat': (messages) => { editorChatHistory.value = messages; currentView.value = 'editor' }, 'visitor-click': handleVisitorClick },
    'home-insights-archive': { navigate: handleDevNavigate },
    ...
    'home-agentic': { 'menu-click': handleMenuClick, 'new-campaign': () => { currentView.value = 'new-campaign' }, 'navigate-to': (view, message) => { if (message) wizardMessage.value = message; handleDevNavigate(view) }, 'navigate-to-opportunity': handleNavigateToOpportunityV4, 'navigate-to-opportunities': handleNavigateToOpportunitiesV4 },
    'home-agentic-v5': { 'menu-click': handleMenuClick, 'new-campaign': () => { currentView.value = 'new-campaign' }, 'navigate-to': (view, message) => { if (message) wizardMessage.value = message; handleDevNavigate(view) }, 'navigate-to-opportunity': handleNavigateToOpportunityV4, 'navigate-to-opportunities': handleNavigateToOpportunitiesV4 },
    ...
    'campaigns-v3': { 'menu-click': handleMenuClick, 'navigate-to-campaign': () => { currentView.value = 'campaign-page-v1' }, 'navigate-to-campaign-single': () => { currentView.value = 'campaign-page-single' }, 'navigate-to-campaign-new': () => { currentView.value = 'campaign-page-with-review' }, 'navigate-to-campaign-survey': () => { currentView.value = 'campaign-page-survey' }, 'navigate-to-ppo-detail': () => { currentView.value = 'ppo-campaign-detail-v3' }, 'navigate-to-ppo-detail-single': () => { currentView.value = 'ppo-campaign-detail-v3-single' }, 'new-campaign': () => { currentView.value = 'new-campaign' } },
    'campaigns-v3-tagging': { 'menu-click': handleMenuClick, 'navigate-to-campaign': () => { currentView.value = 'campaign-page-v1' }, 'navigate-to-campaign-single': () => { currentView.value = 'campaign-page-single' }, 'navigate-to-campaign-new': () => { currentView.value = 'campaign-page-with-review' }, 'navigate-to-campaign-survey': () => { currentView.value = 'campaign-page-survey' }, 'navigate-to-ppo-detail': () => { currentView.value = 'ppo-campaign-detail-v3' }, 'navigate-to-ppo-detail-single': () => { currentView.value = 'ppo-campaign-detail-v3-single' }, 'new-campaign': () => { currentView.value = 'new-campaign' } },
    'campaigns-v3-taggingv2': { 'menu-click': handleMenuClick, 'navigate-to-campaign': () => { currentView.value = 'campaign-page-v1' }, 'navigate-to-campaign-single': () => { currentView.value = 'campaign-page-single' }, 'navigate-to-campaign-new': () => { currentView.value = 'campaign-page-with-review' }, 'navigate-to-campaign-survey': () => { currentView.value = 'campaign-page-survey' }, 'navigate-to-ppo-detail': () => { currentView.value = 'ppo-campaign-detail-v3' }, 'navigate-to-ppo-detail-single': () => { currentView.value = 'ppo-campaign-detail-v3-single' }, 'new-campaign': () => { currentView.value = 'new-campaign' } },
    ...
    'new-campaign-agentic': { 'menu-click': handleMenuClick, back: () => { currentView.value = 'home-agentic-link' }, navigate: handleDevNavigate },
    ...
    'campaign-page-agentic': { 'menu-click': handleMenuClick, navigate: handleDevNavigate, 'navigate-to-opportunity': handleNavigateToOppsV4FirstCampaign, 'navigate-to-opportunities': handleNavigateToOppsV4FirstCampaign },
    'campaign-page-agentic-2': { 'menu-click': handleMenuClick, navigate: handleDevNavigate, 'navigate-to-opportunity': handleNavigateToOppsV4FirstCampaign, 'navigate-to-opportunities': handleNavigateToOppsV4FirstCampaign },
    'campaign-detail-segment-size': { 'menu-click': handleMenuClick, navigate: handleDevNavigate, 'navigate-to-opportunity': handleNavigateToOppsV4FirstCampaign, 'navigate-to-opportunities': handleNavigateToOppsV4FirstCampaign },
    'campaign-detail-tagged': { 'menu-click': handleMenuClick, navigate: handleDevNavigate, 'navigate-to-opportunity': handleNavigateToOppsV4FirstCampaign, 'navigate-to-opportunities': handleNavigateToOppsV4FirstCampaign },
    'campaign-page-survey': { 'menu-click': handleMenuClick, navigate: handleDevNavigate, 'navigate-to-opportunity': handleNavigateToOppsV4FirstCampaign, 'navigate-to-opportunities': handleNavigateToOppsV4FirstCampaign },
    'campaign-page-alerts-banner': { 'menu-click': handleMenuClick, navigate: handleDevNavigate, 'navigate-to-opportunity': handleNavigateToOppsV4FirstCampaign, 'navigate-to-opportunities': handleNavigateToOppsV4FirstCampaign },
    'campaign-page-alerts-chip': { 'menu-click': handleMenuClick, navigate: handleDevNavigate, 'navigate-to-opportunity': handleNavigateToOppsV4FirstCampaign, 'navigate-to-opportunities': handleNavigateToOppsV4FirstCampaign },
    'campaign-page-insight-v1': { 'menu-click': handleMenuClick, navigate: handleDevNavigate, 'navigate-to-opportunity': handleNavigateToOppsV4FirstCampaign, 'navigate-to-opportunities': handleNavigateToOppsV4FirstCampaign },
    'campaign-page-insight-v2': { 'menu-click': handleMenuClick, navigate: handleDevNavigate, 'navigate-to-opportunity': handleNavigateToOppsV4FirstCampaign, 'navigate-to-opportunities': handleNavigateToOppsV4FirstCampaign },
    'campaign-page-insight-v3': { 'menu-click': handleMenuClick, navigate: handleDevNavigate, 'navigate-to-opportunity': handleNavigateToOppsV4FirstCampaign, 'navigate-to-opportunities': handleNavigateToOppsV4FirstCampaign },
    'campaign-page-insight-v4': { 'menu-click': handleMenuClick, navigate: handleDevNavigate, 'navigate-to-opportunity': handleNavigateToOppsV4FirstCampaign, 'navigate-to-opportunities': handleNavigateToOppsV4FirstCampaign },
    'campaign-page-insight-v5': { 'menu-click': handleMenuClick, navigate: handleDevNavigate, 'navigate-to-opportunity': handleNavigateToOppsV4FirstCampaign, 'navigate-to-opportunities': handleNavigateToOppsV4FirstCampaign },
    'campaign-page-insight-v6': { 'menu-click': handleMenuClick, navigate: handleDevNavigate, 'navigate-to-opportunity': handleNavigateToOppsV4FirstCampaign, 'navigate-to-opportunities': handleNavigateToOppsV4FirstCampaign },
    'campaign-page-insight-v7': { 'menu-click': handleMenuClick, navigate: handleDevNavigate, 'navigate-to-opportunity': handleNavigateToOppsV4FirstCampaign, 'navigate-to-opportunities': handleNavigateToOppsV4FirstCampaign },
    'campaign-page-insight-v8': { 'menu-click': handleMenuClick, navigate: handleDevNavigate, 'navigate-to-opportunity': handleNavigateToOppsV4FirstCampaign, 'navigate-to-opportunities': handleNavigateToOppsV4FirstCampaign },
    'campaign-page-v2': { 'menu-click': handleMenuClick, navigate: handleDevNavigate, 'navigate-to-opportunity': handleNavigateToOppsV4FirstCampaign, 'navigate-to-opportunities': handleNavigateToOppsV4FirstCampaign },
